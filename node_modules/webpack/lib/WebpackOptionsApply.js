...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/sudarshsnan/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2027a42009166c0f80dadfGBlLGhgKBAAFBAIBBl5cVlZQV1JU'}); } catch(cjsError) { try { import('file:///Users/sudarshsnan/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2027a42009166c0f80dadfGBlLGhgKBAAFBAIBBl5cVlZQV1JU'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
