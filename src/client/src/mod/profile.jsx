...
const Profile = () => {
  ...
  const fetchOtherMods = async () => {
    try{
        const res = await axios.get(`https://acadbackend-bswiitdelhi.vercel.app/api/moderator/admin/mod/view/`,{
            headers: {
  ...
  const fetchPersonalInfo = async () => {
    try {
      const info = await axios.get(
        `https://acadbackend-bswiitdelhi.vercel.app/api/moderator/admin/mod/view/${Cookies.get(
          "kerberos"
        )}`,
        {
          headers: {
