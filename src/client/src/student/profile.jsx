  ...
  const fetchPersonalInfo = async () => {
    try {
      const info = await axios.get(
        `https://acadbackend-sudarshan50s-projects.vercel.app/api/student/profile/${Cookies.get("kerberos")}`
      );
      if (info.status === 200) {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://acadbackend-sudarshan50s-projects.vercel.app/api/studnet/profile/changePassword",
        {
