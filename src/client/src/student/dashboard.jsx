...
const StudentDashboard = () => {
  ...
  const authCheck = async () => {
    try {
      const res = await axios.get("https://acadbackend-sudarshan50s-projects.vercel.app/api/auth/check", {
        headers: {
  ...
  useEffect(() => {
    ...
    if (statuses.length === 0) {
      url = `https://acadbackend-sudarshan50s-projects.vercel.app/api/student/queries/?kerberos=${Cookies.get(
        "kerberos"
      )}`;
    } else {
      url = `https://acadbackend-sudarshan50s-projects.vercel.app/api/student/queries/?kerberos=${Cookies.get(
